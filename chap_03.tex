...
l'agrégation par \emph{attention additive} calcule :
\begin{equation}
...
multi-têtes (8 têtes) utilise les requêtes d'émotions comme
...
d'une ressource externe : le NRC Emotion Lexicon 
($d_c{=}10$, catégories binaires) ou SenticNet
 ($d_c{=}5$, dimensions continues du
