...
texte à une polarité (positif, négatif, neutre), la détection d'émotions
vise à identifier des catégories affectives fines (joie, colère, tristesse,
surprise, etc.), souvent multiples et simultanées au sein d'un même énoncé.
...
unique \cite{mohammad2013}. Cette hypothèse ne reflète pas la réalité des
...
tels que GoEmotions \cite{demszky2020}, révèlent qu'une proportion
substantielle des textes porte effectivement plusieurs émotions
simultanées, ce qui invalide l'approche mono-étiquette pour un grand nombre
de cas réels.
...
\item \textbf{Analyser} les résultats au niveau de la classe, au-delà des
  ...
  les émotions rares — l'enjeu applicatif central du sujet.
\end{itemize}
...
Analyse du jeu de données GoEmotions (distribution des étiquettes,
déséquilibre, proportion de textes multi-phrases), choix du
prétraitement et de la longueur de séquence. \\[4pt]
Conception et modélisation &
Formulation du problème, conception de l'architecture HAKE-MER et de ses
quatre modules, définition des hypothèses de recherche H1--H4
(chapitre~3). \\[4pt]
Expérimentation et évaluation &
Implémentation, protocole d'ablation cumulative à budget constant sur
deux backbones, comparaison des ressources de connaissances, analyse par
classe et analyse des erreurs (chapitre~4). \\[4pt]
...
défini les objectifs de recherche qui en découlent. Il a également décrit
le plan de travail structurant la démarche adoptée dans ce mémoire. Le
chapitre suivant propose une revue critique de la littérature, permettant
de situer précisément l'architecture HAKE-MER par rapport aux travaux
existants.
