...
principale. Les campagnes Step~0 à M3 (NRC et SenticNet) sont exécutées
sur DistilBERT-base ; la pondération dynamique M4 complète la ladder
expérimentale (chapitre~\ref{chap:experimentation}).
...
les métriques test et tranche H1 à H3 ; H4 (M4) suit le même contrat
expérimental.
